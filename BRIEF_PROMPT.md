...
- The app moment is a single pivot near the end, right before the CTA — never a mid-video demo. Introduce it as a personal habit, not a feature list. Use a pivot phrase like "Here's what actually worked for me" / "Now here's what I use" / "What I've been using is—", then describe the app functionally as "a method" (not "an app"), e.g. "a method that feeds me bite-sized ideas from actual books instead of brain-rotting content" or "I point my phone at any book and get instant summaries." Tie it back to the same motion/habit the video is about, e.g. "same scrolling motion, but now I'm absorbing wisdom from books."
- The CTA is ALWAYS a comment-to-DM funnel, never a direct pitch or "download this app" line. Close with a variation of: "Comment the word BOOK and I'll send you the method." Never replace it with a vague phrase like "feed your mind," "invest in your growth," or a direct download instruction.
